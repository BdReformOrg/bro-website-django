"""
Django settings for bro_website project.

Generated by 'djangocms' command using django CMS 4.1.1 and Django 5.0.2.
...
ROOT_URLCONF = 'bro_website.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "bro_website", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CMS_TEMPLATES = (
    ("bro_website/base_layout.html", _("Standard")),
    ("bro_website/bro_template.html", _("BRO Template")),
)
